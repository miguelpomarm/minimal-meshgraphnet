...
NOTE: This file is preserved from the original DeepMind implementation for
reference and future compatibility. Running with --model=cloth will NOT
work out of the box in this repository: the angular reinterpretation of
the latent space introduced in the proposed architecture requires each
dataset to be preprocessed with the Sinkhorn-Knopp step that produces
the edge_bin_start and edge_bin_width fields. The cloth dataset would
need a matching preprocessing script to be adapted.
"""
